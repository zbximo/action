...
bind = config_data['base_data']['teacher']['ip'] + ":" + config_data['base_data']['teacher']['port']
print(bind)
...
# 设置进程文件目录
pidfile = './log/teacher_gunicorn.pid'
# 设置访问日志和错误信息日志路径
accesslog = './log/teacher_gunicorn_access.log'
errorlog = './log/teacher_gunicorn_error.log'
