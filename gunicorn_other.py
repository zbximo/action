...
bind = config_data['base_data']['other']['ip'] + ":" + config_data['base_data']['other']['port']
print(bind)
...
# 设置进程文件目录
pidfile = './log/other_gunicorn.pid'
# 设置访问日志和错误信息日志路径
accesslog = './log/other_gunicorn_access.log'
errorlog = './log/other_gunicorn_error.log'
